        ...
        foreach ($headers as $header) {
            switch ($header['field']) {
                        ...
                        switch ($button['type']) {
                            ...
                            case 'details':
                                ...
                                $actionHtml .= '<a href="javascript:;" data-fancybox data-options=\'{"src": "/modulos/viajes/viajes/detalle.php?viaje=' . urlencode($row[$field]) 
                                    . '", "type": "ajax", "closeExisting": true, "clickSlide": false, "touch": false}\' class="btn btn-sm btn-primary shadow-sm" data-toggle="tooltip" data-placement="top" title="Details">
                            ...
                            case 'edit':
                                ...
                                if($row['idstatus'] !== '22') { 
                                    ...
                                    . '", "type": "ajax", "closeExisting": true, "clickSlide": false, "touch": false}\' class="btn btn-sm btn-success shadow-sm" data-toggle="tooltip" data-placement="top" title="Edit">
                            ...
                            case 'editStatus':
                                ...
                                if($row['idstatus'] !== '22') { 
                                    ...
                                    . '", "type": "ajax", "closeExisting": true, "clickSlide": false, "touch": false}\' class="btn btn-sm btn-info shadow-sm" data-toggle="tooltip" data-placement="top" title="Edit Status">
                            ...
                            case 'documents':
                                ...
                                if($row['idstatus'] !== '22') { 
                                    $actionHtml .= '<a href="javascript:;" data-fancybox data-options=\'{"src": "/modulos/viajes/viajes/documentos.php?viaje=' . urlencode($row[$field]) 
                                        . '", "type": "ajax", "closeExisting": true, "clickSlide": false, "touch": false}\' class="btn btn-sm btn-warning shadow-sm" data-toggle="tooltip" data-placement="top" title="Documents">
                            ...
                            case 'delete':
                                ...
                                if($row['idstatus'] !== '22') { 
                                    ...
                                    . '", "type": "ajax", "closeExisting": true, "clickSlide": false, "touch": false}\' class="btn btn-sm btn-danger shadow-sm" data-toggle="tooltip" data-placement="top" title="Add Merchandise">
                ...
                case 'unidad_info':
                    ...
                    if($row['nombreunidad'] == '') {
                        $html .= '<td><span title="Awaiting assignment" style="text-decoration: none; cursor: default;">SIN ASIGNAR</span></td>';
                    } else {
